<?php
	...
	$this->set_css($this->default_theme_path.'/manafi/css/demo_table_jui.css');
	$this->set_css($this->default_css_path.'/ui/simple/'.grocery_CRUD::JQUERY_UI_CSS);
	$this->set_css($this->default_theme_path.'/manafi/css/datatables.css');
	$this->set_css($this->default_theme_path.'/manafi/css/jquery.dataTables.css');
	$this->set_css($this->default_theme_path.'/manafi/extras/TableTools/media/css/TableTools.css');
	...
	$this->set_js_lib($this->default_theme_path.'/manafi/js/jquery.dataTables.min.js');
	$this->set_js($this->default_theme_path.'/manafi/js/datatables-extras.js');
	$this->set_js($this->default_theme_path.'/manafi/js/datatables.js');
	$this->set_js($this->default_theme_path.'/manafi/extras/TableTools/media/js/ZeroClipboard.js');
	$this->set_js($this->default_theme_path.'/manafi/extras/TableTools/media/js/TableTools.min.js');
